...
// NewAPIExceptionFromString msg是json格式
...
// NewVerifyCodeRequiredError 需要验证码
...
// NewPasswordExpired 密码过期
func NewPasswordExpired(format string, a ...interface{}) APIException {
	return NewAPIException("", PasswordExpired, codeReason(PasswordExpired), format, a...)
}
