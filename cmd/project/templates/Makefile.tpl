...
MCUBE_MODULE := "github.com/cloudweops/phoenix"
...
install: ## Install depence go package
	@go install github.com/cloudweops/phoenix/cmd/mcube@latest
...
pb: ## Copy mcube protobuf files to common/pb
	...
	@cp -r ${MCUBE_PKG_PATH}/pb/* common/pb/github.com/cloudweops/phoenix/pb
